...
const scenes = [
  {
    ...
    clue:
      "Cerqueu la escultura",
    question: "A qui representa?",
    answers: ["Sant Jordi"],
  },
  {
    id: "pavello",
    ...
    clue:
      "Un llac poc profund amb pedres",
    question: "Com es diu el pavelló?",
  ...
  },
  {
    ...
    clue:
      "A Montjuïc hi ha un túnel on la gent no només hi passa per sota, també hi puja per les parets.",
    question: "Quin esport es practica?",
    answers: ["Escalada", "Escalar"],
  },
  {
    id: "formacio",
    number: 6,
    ...
    clue:
      "Cerca un un gran edifici on estudien moltes persones que volen dedicar-se a l'educació física i a l'esport.",
    question: "Escriviu-ne les sigles de la façana",
    answers: ["INEFC"],
  },
  {
    ...
    clue:
      "Al Passeig de la Fama hi ha noms de persones que han deixat empremta en l'esport",
    question: "Escriu el nom del jugador de bàsquet que deixa aquest empremta.",
    answers: ["Pau Gasol"],
  },
  {
    id: "comunicacio",
    ...
    clue:
      "Busqueu una torre blanca i molt alta que sembla una agulla apuntant al cel.",
    question: "Escriviu el cognom de l'arquitecte que la va dissenyar.",
    answers: ["Calatrava"],
  },
  {
    id: "museu",
    ...
    answers: ["MNAC", "Museu Nacional d'Art de Catalunya"],
  },
  {
    id: "marato",
    number: 8,
    ...
    clue:
      "Busqueu el monument dedicat a Hwang Young-Jo, guanyador de la marató dels Jocs Olímpics de Barcelona 1992.",
    question: "Escriviu el país d'on era aquest atleta.",
    answers: ["Corea"],
  },
];
